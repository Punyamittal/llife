        ...
        <div className="space-y-4 pt-2">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-1.5">
              {categories
                .filter((c) => c.id !== "all")
                .filter((c) => c.id === "news" || c.id === "campus-updates" || c.id === "academics" || c.id === "events" || c.id === "Confessions" || c.id === "clubs" || c.id === "placements")
                .sort((a, b) => {
                  const order = ["news", "campus-updates", "academics", "events", "Confessions", "clubs", "placements"];
